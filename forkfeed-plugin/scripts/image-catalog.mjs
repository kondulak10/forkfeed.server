// Developer-themed image catalog for forkfeed content. Short ids (img1-img200,
// bg1-bg30) resolve to absolute CloudFront URLs that are stored verbatim on the
// card. Self-contained, zero dependencies.
...
export const IMAGE_CATALOG = [
  ...
  { id: 'img130', name: 'Built a to-do app thinks they are a senior dev', tags: 'git, sarcastic', file: '130_202603270001.jpeg' },
...
/** Resolve a short image id (img47, bg10) to its absolute CDN URL. Throws if unknown. */
